  ...
  * ====================== */
  ...
  Modal.prototype = {
    ...
    hideModal: function () {
      ...
      this.$element.triggerHandler('hidden_two');
      ...
      modal.$element.on('show.modalmanager', targetIsSelf(function (e) {
        ...
        var showModal = function(){
          ...
          that.backdrop(modal, function () {
            ...
            modal.$element.data('oldheight',0);
            var modalOverflow = $(window).height() < modal.$element.height() || modal.options.modalOverflow;
            modal.$element.toggleClass('modal-overflow', modalOverflow)
                    .css('margin-top', modalOverflow ? 0 : 0 - modal.$element.height()/2);
            modal.watcherc=false;
            modal.watcherco=55;
            modal.watcher=setInterval(function(){
                if(Math.abs(parseInt(modal.$element.data('oldheight'))-modal.$element.height())>5){
                  modal.$element.data('oldheight',modal.$element.height());
                  modal.watcherc=true;
                  modal.watcherco=0;
                }
                if(modal.watcherco>2){
                  modal.watcherc=false;
                  var modalOverflow = $(window).height() < modal.$element.height() || modal.options.modalOverflow;
                   modal.$element.toggleClass('modal-overflow', modalOverflow)
                    .css('margin-top', modalOverflow ? 0 : 0 - modal.$element.height()/2);
